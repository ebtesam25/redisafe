        ...
        <div className='grid grid-cols-2 gap-10 mb-3 md:grid-cols-3 lg:grid-cols-12 lg:gap-20'>
          <div className='col-span-3'>
            ...
            <p className='my-4 text-xs leading-normal text-white'>
              ...
              data offline and prevent contracting the COVID-19 virus.
            </p>
          </div>
          <nav className='col-span-1 md:col-span-1 lg:col-span-2'>
            <p className='mb-3 text-xs font-semibold tracking-wider text-white uppercase'>
              Product
            </p>
            <a
              href='#'
              className='flex mb-3 text-sm font-medium text-white transition md:mb-2 hover:text-white'>
              Features
            </a>
            <a
              href='#'
